...
open class FAXDeliveryReceiptRulesAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func faxDeliveryReceiptAutomationsGet(page: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        faxDeliveryReceiptAutomationsGetWithRequestBuilder(page: page, limit: limit).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func faxDeliveryReceiptAutomationsGetWithRequestBuilder(page: Int? = nil, limit: Int? = nil) -> RequestBuilder<String> {
        let path = "/automations/fax/receipts"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
