...
open class FAXDeliveryReceiptRulesAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func faxDeliveryReceiptAutomationsGet(q: String, page: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func faxDeliveryReceiptAutomationsGetWithRequestBuilder(q: String, page: Int? = nil, limit: Int? = nil) -> RequestBuilder<String> {
        let path = "/automations/fax/receipts"
        let URLString = SDKClientAPI.basePath + path
        let parameters: [String:Any]? = nil
