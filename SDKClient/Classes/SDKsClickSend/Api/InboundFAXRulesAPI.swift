...
open class InboundFAXRulesAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func faxInboundAutomationsGet(q: String, page: Int? = nil, limit: Int? = nil, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func faxInboundAutomationsGetWithRequestBuilder(q: String, page: Int? = nil, limit: Int? = nil) -> RequestBuilder<String> {
        let path = "/automations/fax/inbound"
        let URLString = SDKClientAPI.basePath + path
        let parameters: [String:Any]? = nil
